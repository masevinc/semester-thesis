...
def process_image(input_image_path, physical_domain_height=1.0, save_steps=False, output_dir=None):
    ...
    threshold_value = 40  # tweak this manually based on what works best
...
points = process_image(
    input_image_path="./double_ramp_configuration/X_dummy_code_playground/png_input/density_plot.png",
    physical_domain_height=256.0,
    save_steps=True,
    output_dir="./double_ramp_configuration/X_dummy_code_playground/output/cv_steps"
)
